...
class HOTEL_CERRADO:
    def __init__(self):
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#7CFC00")
        ...
        self.Message6.configure(background="#7CFC00")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''SEJA BEM VINDO!''')
        ...
        self.Button2.configure(background="#ADFF2F")
        ...
        self.Button2.configure(text='''1.VERIFICAR ESTALAGEM''')
        ...
        self.Button3.configure(background="#ADFF2F")
        ...
        self.Button4.configure(background="#ADFF2F")
        ...
        self.Button4.configure(text='''3.VERIFICAÇÃO DE SAÍDA''')
        ...
        self.Button5.configure(background="#ADFF2F")
        ...
        self.Button5.configure(text='''4.OBTENHA INFORMAÇÕES DE QUALQUER CONVIDADO''')
        ...
        self.Button6.configure(background="#ADFF2F")
