...
def chk_add():
    while True:
        print("\n")
        address = input("DIGITE O ENDEREÇO ​​DO CONVIDADO:")
        a = address.isdigit()
...
def chk_mo():
    while True:
        print("\n")
        mobile_no = input("ENTRAR CELULAR.:")
...
def chk_day():
    while True:
        print("\n")
        no_of_days = input("ENTRAR.NUMERO DIAS O HÓSPEDE QUER FICAR:")
...
def chk_pay():
    while True:
        print("\n")
        op = input(" Digite a escolha do hóspede:")
        a = op.isdigit()
