...
class HOTEL_CERRADO_checkin:
    def __init__(self):
        ...
        self.Labelframe1.configure(text='''LISTA DE TODOS OS CONVIDADOS''')
        ...
        self.Label1.configure(background="#7CFC00")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#7CFC00")
        ...
        self.Label2.configure(background="#7CFC00")
