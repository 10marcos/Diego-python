...
def restart_program():
    ...
    Nota: esta função não retorna. Qualquer ação de limpeza (como
    salvar dados) deve ser feito antes de chamar esta função."""
    ...
    def __init__(self):
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "Número De Celular Foi Inserido""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "Entrada Inválida, Insira Um Número De Celular Válido""\n")
                break
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "Dias Foi Inserido""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "Entrada Inválida ""\n")
                    break
        ...
        def payment_option(self):
            ...
            if op == 1:
                ...
                self.Text1.insert(INSERT, "10% Desconto""\n")
        ...
        def submit_clicked():
            if self.var1.get()==1 and self.var2.get()==0 and self.var3.get()==0 and self.var4.get()==0 and self.var5.get()==1 and self.var6.get()==0:
                ...
                self.Text1.insert(INSERT, "Escolha Inválida Por Favor Insira Uma Escolha Válida""\n")
        ...
        '''Esta classe configura e preenche a janela de nível superior.
           top é a janela que contém o nível superior.'''
        ...
        root.title("HOTEL CERRADO")
        root.configure(background="#7CFC00")
        ...
        self.Message1.configure(text='''DETALHES DE HOSPEDE ''')
        ...
        self.Label3.configure(text='''DIGITAR NOME''')
        ...
        self.Label4.configure(text='''DIGITAR TELEFONE''')
        ...
        self.Label6.configure(text='''Escolha de Quarto''')
        ...
        self.Label7.configure(text='''Metodo De Pagamento ''')
        ...
        self.Checkbutton4.configure(text='''Conjuto''')
        ...
        self.Checkbutton5.configure(text='''Cartão De Credito/Debito''')
        ...
        self.Button4.configure(text='''VERIFICAR''')
        ...
        self.Label1.configure(text='''NUMERO DE DIAS''')
