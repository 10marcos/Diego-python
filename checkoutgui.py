...
class New_Toplevel:
    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                ...
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "NENHUM HÓSPEDE ENCONTRADO""\n")

                    elif n == 1:

                        self.Text1.insert(INSERT, "OBRIGADA  " + name1.upper() + "VOLTE SEMPRE PARA NOS VISITAR""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
                ...
                self.Text1.insert(INSERT, "Entrada Inválida, Insira Um QUARTO Válido.""\n")
        ...
        self.Label1.configure(text='''ENTRAR NO QUARTO.   :''')
        ...
        self.Button1.configure(text='''VERIFICAR''')
